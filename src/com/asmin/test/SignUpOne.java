...
public class SignUpOne extends JFrame implements ActionListener{
	...
	long random;
	JTextField nam,fnam,emailTextField,addressTextField,cityTextField,stateTextField,pincodeTextField;
	JButton next;
	...
	SignUpOne(){
		...
		nam = new JTextField();
		nam.setFont(new Font("Raleway", Font.BOLD, 14));
		...
		fnam = new JTextField();
		fnam.setFont(new Font("Raleway", Font.BOLD, 14));
		fnam.setBounds(300, 190, 400, 30);
		add(fnam);
